...
; !
/**
 * 此文件作了部分修改，解决bug。gjwue@isoftstone.com
 */
function(e, t) {
    "use strict";
    ...
    r = {
        ...
        ready: function(e) {
            ...
            return this; // 不创建样式，由seajs加载 gjwue@isoftstone.com
        ...
        // 增加三个常用方法，有针对性地进行信息提示 gjwue@isoftstone.com
        warn: function(t) {
            this.msg(t, {
                icon: 0,
                time: 2e3
        ...
        if (t[0]) {
            ...
            f = function() {
                if (n === o.type[1] && "object" === t.attr("conType")) {
					...
					// bug修复，当不存在 layui-layer-wrap 时，不能正常删除掉对话框 gjwue@isoftstone.com
                    if (t.find("." + l[5]).length>0 && t.find("." + l[5]).children().length==0) {
                    	t.remove();
                    }
                    /////////////////////////////////////////////////////////////////////////////////////////
            ...
            if (r.ie && r.ie < 10 || !t.data("isOutAnim") ){
            	f() ;
            } else {
            	 setTimeout(function() {
                     f()
